    ...
    <div ref={containerRef} className="w-full bg-white">
      <section ref={sectionRef as any} className="relative w-full py-12 lg:py-24 overflow-hidden z-20 bg-white">
        ...
        <div className="relative w-full lg:w-1/2 flex items-end justify-center lg:justify-start gap-4 lg:gap-6 min-h-[300px] lg:min-h-[500px] pl-0 lg:pl-6">
          ...
          {/* Arch Image (Left) */}
          <div ref={leftImage1Ref} className="relative w-[45%] max-w-[260px] aspect-[2.8/4] rounded-t-[500px] overflow-hidden shadow-xl mt-10 lg:mt-16 z-10 border-4 border-white opacity-0 bg-gray-100">
            <img 
              src="/Home/The%20Wellness%20Spectrum/Holistic%20%26%20Integrative%20Wellness.webp" 
              alt="Ayurvedic Herbs"
              className="w-full h-full object-cover"
            />
          </div>

          {/* Pill Image (Right) - Now a Video */}
          <div ref={leftImage2Ref} className="relative w-[45%] max-w-[260px] aspect-[1/2.2] rounded-full overflow-hidden shadow-xl mb-4 lg:mb-8 z-10 border-4 border-white opacity-0 bg-gray-100">
            <video 
              src="/Videos/Yoga.mp4"
              autoPlay
              loop
        ...
        <div ref={rightContentRef} className="w-full lg:w-1/2 flex flex-col gap-3 lg:gap-5 lg:pl-6">
          ...
          <div className="grid grid-cols-4 gap-2 mt-2 lg:mt-4 max-w-[420px] opacity-0">
            ...
            <div className="flex flex-col items-center gap-1.5 lg:gap-3">
              ...
              <span className="text-gray-600 text-[9px] lg:text-[11px] font-semibold text-center leading-tight">Deep<br/>Reflection</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-1.5 lg:gap-3">
              ...
              <span className="text-gray-600 text-[9px] lg:text-[11px] font-semibold text-center leading-tight">Spiritual<br/>Harmony</span>
            </div>
          </div>
