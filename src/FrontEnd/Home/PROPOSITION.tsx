        ...
        >
          <div className="relative z-10 grid grid-cols-1 grid-rows-1 w-full items-center">
            ...
            <div className="prop-slide-1 col-start-1 row-start-1 flex flex-col w-full h-fit z-20">
              ...
              {/* Heading */}
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-light tracking-tight text-white leading-[1.1] mb-2 whitespace-nowrap">
                HERE for you.
              </h2>

              <h3 className="text-sm md:text-base text-white/90 font-medium mb-6">
                H.E.R.E (Healing, Education, Research, Exploration)
              </h3>

              <div className="flex flex-col gap-2 w-full max-w-xl">
                <h5 className="text-[10px] font-bold tracking-[0.2em] uppercase text-white/40 mb-1 border-b border-white/10 pb-2">
                ...
                <div className="flex flex-col gap-2">
                  {[
                    ...
                    <div 
                      key={i} 
                      className="group relative overflow-hidden bg-white/[0.02] border border-white/5 rounded-xl p-3 transition-all duration-300 hover:bg-white/[0.04] hover:border-[#d15000]/30 hover:-translate-y-0.5 cursor-default"
                    >
                      ...
                      <div className="relative z-10 pl-2">
                        <h6 className="text-white text-[12px] font-bold mb-0.5 group-hover:text-[#d15000] transition-colors tracking-wide">{item.title}</h6>
            ...
            <div className="prop-slide-2 col-start-1 row-start-1 flex flex-col w-full h-fit opacity-0 translate-y-8 pointer-events-none z-10">
              {/* Label */}
              <h4 className="text-[#d15000] text-[10px] font-bold tracking-[0.2em] uppercase mb-4 border-b border-white/10 pb-3 inline-block">
                BRAND STORY (H.E.R.E FOR YOU)
              </h4>

              {/* Heading */}
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-light tracking-tight text-white/90 leading-[1.1] mb-12">
                The Agora of Wisdom.
              </h2>
              ...
              <div className="flex flex-col gap-2 w-full max-w-xl">
                {[
                  ...
                  >
                    <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-[#d15000]/30 to-transparent group-hover:from-[#d15000] group-hover:to-[#d15000]/30 transition-colors duration-300" />
                    <div className="relative z-10 pl-2">
                      <h6 className="text-white text-[12px] font-bold mb-0.5 group-hover:text-[#d15000] transition-colors tracking-wide uppercase">{item.label}</h6>
                      <p className="text-white/50 text-[11px] leading-relaxed">{item.desc}</p>
                    </div>
                  </div>
                ))}
