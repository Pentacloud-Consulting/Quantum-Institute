  ...
  return (
    <div className="w-full bg-[#050505] h-auto lg:h-[100dvh] pt-24 pb-12 lg:pt-28 flex flex-col text-white font-sans relative overflow-hidden">
      ...
      <div className="flex justify-between items-center px-4 md:px-12 pb-8 border-b border-white/20">
        <span className="text-xs md:text-sm tracking-widest text-white/70">/Our Services</span>
          ...
          return (
            ...
            >
              ...
              >
                ...
                <motion.div layout className="flex items-center justify-center w-full max-w-[95vw] md:max-w-[90vw] mx-auto">
                  <motion.span 
                    layout 
                  ...
                  <AnimatePresence>
                    {isHovered && (
                      <motion.div
                        ...
                        transition={{ type: "spring", stiffness: 300, damping: 30 }}
                        className="flex justify-center overflow-hidden mx-2 sm:mx-4 md:mx-6 shrink-0"
                      >
                        <img 
                          src={item.img} 
                          alt={item.title1} 
                  ...
                  <motion.span 
                    layout 
                    className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-medium tracking-tight whitespace-nowrap ml-2 sm:ml-4"
                  >
                    {item.title2}
                  </motion.span>
                </motion.div>
                ...
                <AnimatePresence>
                  {isHovered && (
                    ...
                    >
                      <motion.p layout className="pt-4 md:pt-6 pb-2 text-white/60 text-[10px] sm:text-[11px] md:text-xs tracking-wide text-center max-w-sm md:max-w-xl uppercase px-4">
                        {item.subtitle}
                      </motion.p>
                    </motion.div>
                  )}
